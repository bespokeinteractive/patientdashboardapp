...
<section>
	...
	<fieldset>
		...
		<div class="onerow underline" style="padding-top: 10px;">
			<h2>Any family history of the following illness? </h2>
			<div class="checkboxes">
				<label><input type="checkbox" id="Hypertension" value="Hypertension" name="patientFamilyHistory.familyIllnessHistory" <%if(patientFamilyHistory?.familyIllnessHistory == "Hypertension") { %> checked="checked"<% } %>/>   Hypertension</label>

				<label><input type="checkbox" id="Tuberculosis" value="Tuberculosis" name="patientFamilyHistory.familyIllnessHistory" <%if (patientFamilyHistory?.familyIllnessHistory == "Tuberculosis") {%> checked="checked"<%} %>/>  Tuberculosis </label>

				<label><input type="checkbox" id="Sudden Death" value="Sudden Death" name="patientFamilyHistory.familyIllnessHistory" <% if(patientFamilyHistory?.familyIllnessHistory == "Sudden Death") {%> checked="checked"<% }%>/>  Sudden Death </label>

				<label><input type="checkbox" id="Stroke" value="Stroke" name="patientFamilyHistory.familyIllnessHistory"<%if (patientFamilyHistory?.familyIllnessHistory=="Stroke"){%> checked="checked"<%}%> />Stroke</label>

				<label><input type="checkbox" id="Asthma" value="Asthma" name="patientFamilyHistory.familyIllnessHistory" <%if(patientFamilyHistory?.familyIllnessHistory=="Asthma"){%> checked="checked" <%}%>/> Asthma</label>

				<label><input type="checkbox" id="Diabetes" value="Diabetes" name="patientFamilyHistory.familyIllnessHistory" <%if(patientFamilyHistory?.familyIllnessHistory=="Diabetes"){%>checked="checked" <%}%> />Diabetes</label>

				<label><input type="checkbox" id="Others" value="Others" name="patientFamilyHistory.familyIllnessHistory" <%if(patientFamilyHistory?.familyIllnessHistory=="Others"){%>checked="checked"<%}%>/>Others</label>

				<label><input type="checkbox" id="None" value="None" name="patientFamilyHistory.familyIllnessHistory" <%if(patientFamilyHistory?.familyIllnessHistory=="None"){%>checked="checked"<%}%>/> None</label>
